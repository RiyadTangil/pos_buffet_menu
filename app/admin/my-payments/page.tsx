...
export default function MyPaymentsPage() {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      // Load payments
      const { payments: paymentsData, pagination: paginationData } =
      ...
      <Card>
        <CardContent className="py-4">
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-2">
              <Label htmlFor="table" className="text-xs text-muted-foreground">
                Table:
              </Label>
            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {payments.map((payment) => (
                  <Card key={payment.id} className="border-blue-300">
                    <CardContent className="p-4 space-y-3">
                      ...
                      <div className="flex items-center gap-2 text-sm text-muted-foreground">
                        ...
                        <Badge
                          variant={getSessionBadgeVariant(payment.sessionType)}
                          className="ml-auto"
                        >
                          {payment.sessionType.charAt(0).toUpperCase() +
                            payment.sessionType.slice(1)}
                        </Badge>
                      </div>

                      <div className="text-sm text-muted-foreground">
                        Waiter {payment.waiterName}
                      </div>
                    </CardContent>
                  </Card>
                ))}
